<template>
  <div class="background text">
    <br/>
    <h1>Fill out the form below to add a Pitch!</h1>
    <br/>
    <form class="form, text" @submit.prevent="submit">
      <div class="form-group">
        <label class="form-control-label" name="pitchLocation">Enter a location for the Pitch
          <input class="form_input" v-model.trim="$v.pitchLocation.$model"/>
        </label>
      </div>
      <div class="form-group">
        <label class="form-label">Pitch Lights
          <select id="pitchLights" name="pitchLights" class="form-control" type="text" v-model="pitchLights">
      ...
      <div class="form-group">
        <label class="form-label">Select Pitch Sport
          <select id="pitchSport" name="pitchSport" class="form-control" type="text" v-model="pitchSport">
            <option value="null" selected disabled hidden>Choose Pitch Sport</option>
      ...
      <div class="form-group" :class="{ 'form-group--error': $v.pitchAge.$error }">
        <label class="form-control-label" name="age">Enter Pitch Age
          <input class="form__input" type="number" v-model.trim="pitchAge"/>
        </label>
      </div>
      ...
      <p class="typo__p" v-if="submitStatus === 'OK'">Pitch Added!</p>
